...
2. Complete the form with your first name and email address, and then click the "next" button.
...
3. Complete step 2 of the registration form with a password, and move on to step 3.
<img src="../images/sandbox-register-step2.png" width="600" alt="ORCID Sandbox registration form step 2" />
4. Select your preferred visibility setting, accept the terms of use, click the box next to the text "I'm not a robot", and finally click the "register" button.
...
2. **Add employment:** In the **Employment** section, click **Add employment**, fill out the form and click **Add to list**.
